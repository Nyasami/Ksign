...
struct PrivacyPolicyView: View {
    ...
    var body: some View {
        NBNavigationView(.localized("《服务及隐私协议》")) {
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    // 内容
                    if isFirstLaunch {
                        Text("请向下滚动阅读完整协议内容，阅读完毕后点击底部的同意按钮继续使用应用。")
                            .font(.headline)
...
1.1为了更好地为您提供服务，请您仔细阅读这份协议。本协议是您与本应用就您使用本应用平台等所涉及的全部行为所订立的权利义务规范。您在使用TBox应用时，表明您已完全同意并接受本协议，愿意遵守本协议的各项规则、规范的全部内容，若不同意则可停止使用本应用平台。如您是未成年人，您还应要求您的监护人仔细阅读本协议，并取得他/他们的同意。
...
3.1 您知晓并同意，您并不会将TBox所提供的任何一项服务用于违反任何国家相关法律的用途，否则，由此而出现的所有法律后果，将由您自行全部承担；
3.2 您知晓并同意，您不会添加任何含有违法内容、侵犯版权等的软件源。添加软件源属于个人行为，与本App无关，否则，所产生的任何法律风险和后果将由您自行全部承担；
3.3 您知晓并同意，您不会签名任何含有违法内容、侵犯版权等的ipa包。签名ipa包属于个人行为，与本App无关，否则，所产生的任何法律风险和后果将由您自行全部承担；
3.4 您知晓并同意，您不会安装任何含有违法内容、侵犯版权等的ipa包。安装ipa包属于个人行为，与本App无关，否则，所产生的任何法律风险和后果将由您自行全部承担；
3.5 您知晓并同意，您不会下载任何含有违法内容、侵犯版权等的视频。下载视频属于个人行为，与本App无关，否则，所产生的任何法律风险和后果将由您自行全部承担；
3.6 您知晓并同意，您没有向TBox提交任何的虚假信息或材料，也没有故意隐瞒您的App 中可能存在的违法内容。否则，由此出现的所有后果，将由您自行全部承担；
3.7 您知晓并同意，由于TBox技术原因可能导致app闪退、不能正常使用，您将承担该风险以及该风险导致的后续一切损失；
3.8 您知晓并同意，您向我们提供的 App（手机应用程序）保证您拥有完整独立的知识产权，包括但不限于外观设计、著作权、文本，图形，徽标，按钮图标，图像，音频剪辑，且不会被用于未经许可的任何有关产品或服务；
3.9 您知晓并同意，我们在需要时通过技术手段合法收集和使用有关您及您提供的App（手机应用程序）所使用本服务的技术性或诊断性信息，收集到的信息将用于改进我们的服务内容，提升我们的服务品质。我们不会将您的信息和内容分享或出售给其他的组织；
...
5.3 本应用的所有内容，包括商品描述、图片等内容所有权归属于TBox的用户，任何人不得转载。
